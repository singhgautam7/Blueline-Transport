...
export const siteContent = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Part Load (LTL)",
        description:
          "Pay only for the space you use — shared trucking with safe handling for smaller, frequent dispatches.",
      },
      {
        icon: "route",
      ...
      },
      {
        ...
        description:
          "Every consignment covered and visible — live GPS, e-POD and a single point of contact per account.",
      },
      {
        icon: "clock",
  ...
  coverage: {
    ...
    // Hubs shown in the list and as nodes on the map. `mapX`/`mapY` position
    // the node on the 280×360 map illustration. `hq` marks the head office;
    // `comingSoon` styles a hub as an upcoming location.
    hubs: [
      { city: "Mumbai", note: "Bhiwandi hub · Maharashtra", hq: true, mapX: 92, mapY: 196, primary: true },
      { city: "Pune", note: "Chakan industrial belt", mapX: 120, mapY: 206 },
      { city: "Ahmedabad", note: "Gujarat distribution centre", mapX: 96, mapY: 132 },
      { city: "Bengaluru", note: "Next hub — our South India gateway", comingSoon: "Coming 2026", mapX: 150, mapY: 286 },
    ],
  },
  ...
  clients: {
    ...
    testimonials: [
      {
        quote:
          "Blueline runs our Maharashtra–Gujarat lane with delivery reliability we can actually plan production around. When something moves, someone answers the phone.",
        initials: "RM",
        author: "Rohan Mehta",
  ...
  about: {
    ...
    paragraphs: [
      "Blueline Transport was founded in Bhiwandi to take the guesswork out of road freight for manufacturers and FMCG distributors. What began as a handful of vehicles on the Mumbai–Pune lane has grown into a network of owned and attached trucks running the western corridor every day.",
  ...
  contact: {
    ...
    form: {
      ...
      footnote: "Prefer to talk? Call {phone} — we answer fast.",
